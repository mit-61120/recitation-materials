...
LValueResolver::LValueResolver(Interpreter &interpreter) : interpreter(interpreter) {}
...
void LValueResolver::visit(const ast::FieldDereference &node) {
    ...
    auto record = static_cast<Record*>(interpreter.result); // In your code, you should convert properly
